...
<center>
    ...
    $pageSizeDropDown = CHtml::dropDownList(
        'pageSize', $pageSize, array(10 => 10, 25 => 25, 50 => 50, 100 => 100), array(
            ...
            'onchange' => "$.fn.yiiGridView.update('sale-payment-grid',{data:{pageSize:$(this).val()}});",
        )
    );
    ?>
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        array(
            ...
            '<div style="display: inline-block"> &nbsp; /' . SalePaymentHeader::CN_CONSTANT . '/ &nbsp; </div>' .
            ...
            'value' => '$data->getCodeNumber(SalePaymentHeader::CN_CONSTANT)',
        ...
        array(
            'header' => 'Customer',
            'filter' => CHtml::dropDownList('CustomerId', $customerId, CHtml::listData(Customer::model()->resetScope()->findAll(array('order' => 't.name')), 'id', 'company'), array('empty' => '')),
            'value' => '($data->saleReceiptHeader->customer === null) ? "" : $data->saleReceiptHeader->customer->company',
        ),
        array(
            'name' => 'branch_id',
