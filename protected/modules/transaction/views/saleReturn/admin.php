...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        array(
            'name' => 'cn_ordinal',
            'header' => 'Retur #',
            'filter' => '<div style="display: inline-block">' . CHtml::activeTextField($saleReturn, 'cn_ordinal', array('maxLength' => 4, 'size' => 2)) . '</div>' .
            '<div style="display: inline-block"> &nbsp; /' . SaleReturnHeader::CN_CONSTANT . '/ &nbsp; </div>' .
            '<div style="display: inline-block">' . CHtml::activeDropDownList($saleReturn, 'cn_month', array(1 => 'I', 'II', 'III', 'IV', 'V', 'VI', 'VII', 'VIII', 'IX', 'X', 'XI', 'XII'), array('empty' => '')) . '</div>' .
            '<div style="display: inline-block"> &nbsp; / &nbsp; </div>' .
            '<div style="display: inline-block">' . CHtml::activeTextField($saleReturn, 'cn_year', array('maxLength' => 2, 'size' => 2)) . '</div>',
        ...
        array(
            'name' => 'warehouse_id',
            'filter' => CHtml::listData(Warehouse::model()->findAll(array('order' => 't.name')), 'id', 'name'),
...
//			'value' => '$data->saleInvoice->deliveryHeader->customer->company',
//		),
        array(
            'class' => 'CButtonColumn',
