...
<?php if ((int)$expense->is_approved === 0 && Yii::app()->user->checkAccess('administrator')): ?>
    <div>
        <?php echo CHtml::beginForm(); ?>
        <?php echo CHtml::submitButton('Confirm Sales Order', array('name' => 'Submit')); ?>
