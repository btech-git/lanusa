<table style="border: 1px solid">
        ...
        <?php foreach ($expense->details as $i=>$detail): ?>
			...
			<td style="text-align: center; width: 15%">
				<?php echo CHtml::activeTextField($detail, "[$i]amount", array('size'=>10, 'maxlength'=>18,
					'onchange'=>CHtml::ajax(array(
						'type'=>'POST',
						'dataType'=>'JSON',
						'url'=>CController::createUrl('AjaxJsonTotal', array('id' => $expense->header->id,'index'=>$i)),
				...
				<?php if ($detail->isNewRecord): ?>
					<?php echo CHtml::button('Delete', array(
						'onclick'=>CHtml::ajax(array(
							'type'=>'POST',
							'url'=>CController::createUrl('AjaxHtmlRemoveAccount', array('id' => $expense->header->id,'index'=>$i)),
							'update'=>'#detail_div',
						)),
					)); ?>
				<?php else: ?>
        ...
        <tr style="background-color: aquamarine">
			...
			<td style="font-weight: bold; text-align: center">
				<span id="total">
					<?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', $expense->total)); ?></td>
				</span>
			<td></td>
			<td></td>
        </tr>
