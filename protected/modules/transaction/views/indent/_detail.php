<table style="border: 1px solid">
    ...
    <?php foreach ($indent->details as $i => $detail): ?>
        ...
        <tr style="background-color: azure">
            ...
            <td style="text-align: center; width: 5%">
                ...
                echo CHtml::activeTextField($detail, "[$i]quantity", array('size' => 7, 'maxLength' => 20,
                    ...
                    CHtml::ajax(array(
                        'type' => 'POST',
                        'dataType' => 'JSON',
                        'url' => CController::createUrl('AjaxJsonTotal', array('id' => $indent->header->id, 'index' => $i)),
            ...
            <td style="text-align: center; width: 15%">
                <?php
                echo CHtml::activeTextField($detail, "[$i]unit_price", array('size' => 10, 'maxLength' => 20,
                ...
                <?php if ($detail->isNewRecord): ?>
                    ...
                    echo CHtml::button('Delete', array(
                        'onclick' => CHtml::ajax(array(
                            'type' => 'POST',
                            'url' => CController::createUrl('AjaxHtmlRemoveProduct', array('id'=>$indent->header->id, 'index'=>$i)),
                            'update' => '#detail_div',
                        )),
                    ));
                    ?>
    ...
    <tr style="background-color: aquamarine">
        ...
        <td style="text-align: right; font-weight: bold">
			<span id="grand_total">
                <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', $indent->grandTotal)); ?>
            </span>
        </td>
        <td></td>
    </tr>
