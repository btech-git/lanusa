<?php class DeliveryOutstandingInvoiceController extends Controller {
    ...
    public function actionSummary() {
        ...
        $branch = Branch::model()->findByPk($deliveryHeader->branch_id);
        ...
        $deliveryOutstandingInvoice = new DeliveryOutstandingInvoice($deliveryHeader->searchByOutstandingInvoiceReport());
        $deliveryOutstandingInvoice->setupLoading();
        $deliveryOutstandingInvoice->setupPaging($pageSize, $currentPage);
        $deliveryOutstandingInvoice->setupSorting();
        $filters = array(
            'startDate' => $startDate,
            'endDate' => $endDate,
            'branchId' => $branchId,
        ...
        $deliveryOutstandingInvoice->setupFilter($filters);

        if (isset($_GET['SaveExcel']))
            $this->saveToExcel($deliveryOutstandingInvoice, $branch, $deliveryOutstandingInvoice->dataProvider, array('startDate' => $startDate, 'endDate' => $endDate));

        $this->render('summary', array(
            'deliveryHeader' => $deliveryHeader,
            'deliveryOutstandingInvoice' => $deliveryOutstandingInvoice,
            'startDate' => $startDate,
            'endDate' => $endDate,
    ...
    public function actionAjaxHtmlCustomer() {
    ...
    protected function saveToExcel($deliveryOutstandingInvoice, $branch, $dataProvider, array $options = array()) {
