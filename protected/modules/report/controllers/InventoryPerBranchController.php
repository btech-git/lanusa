...
class InventoryPerBranchController extends Controller {
    ...
    public function actionSummary() {
        ...
        $inventorySummary = new InventoryPerBranchSummary($product->search());
        ...
        if (isset($_GET['SaveExcel']))
            $this->saveToExcel($inventorySummary, $branchId, $inventorySummary->dataProvider, array('startDate' => $startDate, 'endDate' => $endDate));
    ...
    protected function saveToExcel($inventorySummary, $branchId, $dataProvider, array $options = array()) {
