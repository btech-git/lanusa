<?php class InvoiceOutstandingReceiptController extends Controller {
    ...
    public function actionSummary() {
        ...
        $invoiceOutstandingReceipt = new InvoiceOutstandingReceipt($saleInvoice->searchByReceipt());
        $invoiceOutstandingReceipt->setupLoading();
        $invoiceOutstandingReceipt->setupPaging($pageSize, $currentPage);
        $invoiceOutstandingReceipt->setupSorting();
        $filters = array(
            'startDate' => $startDate,
            'endDate' => $endDate,
            'branchId' => $branchId,
        ...
        $invoiceOutstandingReceipt->setupFilter($filters);

        if (isset($_GET['SaveExcel']))
            $this->saveToExcel($invoiceOutstandingReceipt, $branch, $invoiceOutstandingReceipt->dataProvider, array('startDate' => $startDate, 'endDate' => $endDate));

        $this->render('summary', array(
            'saleInvoice' => $saleInvoice,
            'invoiceOutstandingReceipt' => $invoiceOutstandingReceipt,
            'startDate' => $startDate,
            'endDate' => $endDate,
    ...
    protected function saveToExcel($invoiceOutstandingReceipt, $branch, $dataProvider, array $options = array()) {
