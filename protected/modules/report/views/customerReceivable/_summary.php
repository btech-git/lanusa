...
<div style="font-weight: bold; text-align: center">
    ...
    <div style="font-size: larger">Laporan Piutang</div>
    <div>Sampai Tanggal <?php echo CHtml::encode(Yii::app()->dateFormatter->format('d MMMM yyyy', strtotime($endDate))); ?></div>
</div>
...
<table class="report">
    ...
    <?php foreach ($accounts as $account): ?>
        <?php $totalReceivable = $account->getCustomerReceivableBalance($branchId, $endDate); ?>
        <?php if ($totalReceivable > 100 || $totalReceivable < -100): ?>
            <tr class="items1">
                <td class="width1-1">
