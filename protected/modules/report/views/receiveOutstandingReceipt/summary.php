...
Yii::app()->clientScript->registerScript('report', '
	...
	$("#EndDate").val("' . $endDate . '");
	$("#PageSize").val("' . $receiveOutstandingReceipt->dataProvider->pagination->pageSize . '");
	$("#CurrentPage").val("' . ($receiveOutstandingReceipt->dataProvider->pagination->getCurrentPage(false) + 1) . '");
...
$this->widget('system.web.widgets.pagers.CLinkPager', array(
    'itemCount' => $receiveOutstandingReceipt->dataProvider->pagination->itemCount,
    'pageSize' => $receiveOutstandingReceipt->dataProvider->pagination->pageSize,
    'currentPage' => $receiveOutstandingReceipt->dataProvider->pagination->getCurrentPage(false),
));
?>
    </div>
    <div class="clear"></div>
