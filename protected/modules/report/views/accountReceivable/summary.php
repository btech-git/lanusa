...
<div class="hide">
    <div class="form" style="text-align: center">
        ...
        <div id="customer_div" class="row" style="background-color: #DFDFDF">
            Customer
            <?php
            echo CHtml::activeDropDownlist($saleInvoice, 'customerId',
                    CHtml::listData(Customer::model()->findAll(array('order' => 'name ASC')), 'id', 'company'),
                    array('empty' => '-- Semua Customer --'));
            ?>
        </div>
...
<?php echo CHtml::endForm(); ?>
    ...
    <div class="clear"></div>
    <div class="right">
<?php echo ReportHelper::sortText($agingPayableSummary->dataProvider->sort, array('Tanggal', 'Customer')); ?>
    </div>
    <div class="clear"></div>
</div>
