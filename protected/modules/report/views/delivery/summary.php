...
<?php echo CHtml::endForm(); ?>
    ...
    <div class="clear"></div>
    <div class="right">
<?php echo ReportHelper::sortText($deliverySummary->dataProvider->sort, array('Tanggal', 'Customer')); ?>
    </div>
    <div class="clear"></div>
</div>

<div>
        <?php $this->renderPartial('_summary', array('deliverySummary' => $deliverySummary, 'deliveryHeader' => $deliveryHeader, 'branch' => $branch, 'startDate' => $startDate, 'endDate' => $endDate)); ?>
</div>
