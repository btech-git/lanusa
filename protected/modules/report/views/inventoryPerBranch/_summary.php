...
<div style="font-weight: bold; text-align: center">
	<div style="font-size: larger">Laporan Gudang Per Cabang</div>
...
<!--		<th class="width1-5">Stok Akhir</th>-->
	...
	<?php foreach ($inventorySummary->dataProvider->data as $header): ?>
		<tr class="items1">
			...
			<td class="width1-4">
				<?php echo $header->getInventoryReportStockBranchFromBeginningTo($startDate, false, $branchId); ?>
			</td>
<!--			<td style="text-align: center">
				<?php //echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', $header->getInventoryReportStockBranchFromBeginningTo($endDate, true, $branchId))); ?>
			</td>-->
		</tr>
		<tr class="items2">
			<td colspan="4">
				<table>
				<?php $reportCurrentStock = $header->getInventoryReportStockBranchFromBeginningTo($startDate, false, $branchId); ?>
					<?php foreach ($header->inventories as $detail): ?>
                        <tr>
                            ...
                            <td class="width2-10"><?php echo CHtml::encode(CHtml::value($detail, 'branch.name')); ?></td>	
                        </tr>
