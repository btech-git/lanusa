...
Yii::app()->clientScript->registerScript('report', '
	...
	$("#PageSize").val("' . $stockGlobalSummary->dataProvider->pagination->pageSize . '");
	$("#CurrentPage").val("' . ($stockGlobalSummary->dataProvider->pagination->getCurrentPage(false) + 1) . '");
...
//					'options' => array($branch => array('selected' => TRUE)))); //to preserve the selected value
    ...
    <div class="right"><?php echo ReportHelper::summaryText($stockGlobalSummary->dataProvider); ?></div>
    <div class="clear"></div>
    <div class="right">
        <?php echo ReportHelper::sortText($stockGlobalSummary->dataProvider->sort, array('Nama Produk', 'Kategori')); ?>
    </div>
    <div class="clear"></div>
</div>

<div>
    <?php $this->renderPartial('_summary', array('stockGlobalSummary' => $stockGlobalSummary)); ?>
</div>
...
<div class="hide">
    <div class="right">
        ...
        $this->widget('system.web.widgets.pagers.CLinkPager', array(
            'itemCount' => $stockGlobalSummary->dataProvider->pagination->itemCount,
            'pageSize' => $stockGlobalSummary->dataProvider->pagination->pageSize,
            'currentPage' => $stockGlobalSummary->dataProvider->pagination->getCurrentPage(false),
        ));
        ?>
    </div>
    <div class="clear"></div>
