...
class StockLocalSummary extends CComponent {
    ...
    public function setupFilter($categoryId, $warehouseId) {
        ...
        $this->dataProvider->criteria->addCondition("EXISTS (
            ...
            WHERE t.id = i.product_id AND i.warehouse_id = :warehouse_id
            HAVING stock > 0
        )");
        $this->dataProvider->criteria->params[':warehouse_id'] = $warehouseId;
    }
