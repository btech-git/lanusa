...
class SalePaymentSummary extends CComponent
{
	public $dataProvider;
	...
	public function setupLoading()
	{
		$this->dataProvider->criteria->with = array(
			'salePaymentDetails'=>array(
				'with'=>array('paymentType:resetScope', 'account:resetScope'),
			),
	...
	public function setupFilter(array $filters)
	{
		...
		$this->dataProvider->criteria->compare('saleReceiptHeader.customer_id', $filters['customerId']);
