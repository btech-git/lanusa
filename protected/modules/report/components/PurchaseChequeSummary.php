...
class PurchaseChequeSummary extends CComponent
{
	public $dataProvider;
	...
	{
		$this->dataProvider->sort->attributes = array('issue_date', 'supplier.company');
	...
	public function setupFilter($startDate, $endDate, $supplierId)
	{
		...
		$this->dataProvider->criteria->addBetweenCondition('issue_date', $startDate, $endDate);
		$this->dataProvider->criteria->compare('supplier.id', $supplierId);
	}
