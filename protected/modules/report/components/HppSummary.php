...
class HppSummary extends CComponent
{
	public $dataProvider;
	...
	{
		$this->dataProvider->criteria->with = array('category:resetScope');
	...
	public function setupFilter($productName, $productCategoryId)
	{
		
		$this->dataProvider->criteria->compare('t.name', $productName, true);
		$this->dataProvider->criteria->compare('t.category_id', $productCategoryId);
