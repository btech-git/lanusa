...
class TransferSummary extends CComponent
{
	public $dataProvider;
	...
	public function setupLoading()
	{
		$this->dataProvider->criteria->with = array(
			...
			'branch:resetScope',
			'warehouseIdFrom:resetScope',
			'warehouseIdTo:resetScope',
		);
	...
	{
		$this->dataProvider->sort->attributes = array('date', 'warehouseIdFrom.name');
