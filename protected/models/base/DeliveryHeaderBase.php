...
class DeliveryHeaderBase extends MonthlyTransactionActiveRecord {
    ...
    public function tableName() {
        return 'tblla_delivery_header';
    }

    public function rules() {
        return array(
            array('cn_ordinal, cn_month, cn_year, date, sale_header_id, branch_id, admin_id', 'required'),
            array('cn_ordinal, cn_month, cn_year, sale_header_id, branch_id, admin_id, is_non_tax, is_inactive', 'numerical', 'integerOnly' => true),
            array('note, customerId, referenceNumber', 'safe'),
            // The following rule is used by search().
            array('id, cn_ordinal, cn_month, cn_year, date, note, sale_header_id, branch_id, admin_id, is_non_tax, is_inactive', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        return array(
            ...
            'saleInvoices' => array(self::HAS_MANY, 'SaleInvoice', 'delivery_header_id'),
        );
    }
