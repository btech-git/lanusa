...
class ClassificationBase extends ActiveRecord {
    ...
    public function relations() {
        return array(
            'categoryClassifications' => array(self::HAS_MANY, 'CategoryClassification', 'classification_id'),
            'products' => array(self::HAS_MANY, 'Product', 'classification_id'),
        );
    }
