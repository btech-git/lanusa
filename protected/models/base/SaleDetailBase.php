...
class SaleDetailBase extends ActiveRecord {
    ...
    public function tableName() {
        return 'tblla_sale_detail';
    }

    public function rules() {
        return array(
            array('product_name, sale_header_id, product_id, unit_id', 'required'),
    ...
    public function relations() {
        return array(
            'deliveryDetails' => array(self::HAS_MANY, 'DeliveryDetail', 'sale_detail_id'),
