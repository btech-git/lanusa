...
<table class="report">
	...
	<?php foreach ($agingScheduleSummary->dataProvider->data as $header): ?>
		<tr class="items1">
...
<tr>
	...
	<td class="width2-3" style="border-top: 1px solid; font-weight: bold; text-align: right">TOTAL PIUTANG</td>
	<td class="width2-4" style="border-top: 1px solid; font-weight: bold; text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', floor($this->reportTotalReceivable($agingScheduleSummary->dataProvider)))); ?></td>
</tr>
</table>			
