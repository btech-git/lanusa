...
Yii::app()->clientScript->registerScript('report', '
	...
	$("#EndDate").val("' . $endDate . '");
	$("#PageSize").val("' . $invoiceOutstandingReceipt->dataProvider->pagination->pageSize . '");
	$("#CurrentPage").val("' . ($invoiceOutstandingReceipt->dataProvider->pagination->getCurrentPage(false) + 1) . '");
...
$this->widget('system.web.widgets.pagers.CLinkPager', array(
    'itemCount' => $invoiceOutstandingReceipt->dataProvider->pagination->itemCount,
    'pageSize' => $invoiceOutstandingReceipt->dataProvider->pagination->pageSize,
    'currentPage' => $invoiceOutstandingReceipt->dataProvider->pagination->getCurrentPage(false),
));
?>
    </div>
    <div class="clear"></div>
