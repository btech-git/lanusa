...
class PurchasePaymentHeaderBase extends MonthlyTransactionActiveRecord {
    ...
    public function search() {
        ...
        $criteria->compare('t.is_using_cheque', $this->is_using_cheque);
