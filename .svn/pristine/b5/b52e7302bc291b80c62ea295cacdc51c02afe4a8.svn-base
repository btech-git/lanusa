...
//        $this->header->status = (int) $this->header->is_using_cheque === 0 ? 'Completed' : 'Pending';
...
//        if ($this->header->is_using_cheque === 0) {
