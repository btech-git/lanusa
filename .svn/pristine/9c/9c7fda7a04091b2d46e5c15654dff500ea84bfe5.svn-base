...
<div id="memoheader">
    ...
    <div style="font-size: larger">Bukti Pengeluaran Kas/Bank</div>
</div>
        ...
        <div class="divtablecell hcolumn1">
            <div class="divtable">
                <div class="divtablerow">
                    <div class="divtablecell info hcolumn1header" style="font-weight: bold">BP No.</div>
                    <div class="divtablecell info hcolumn1value">
                        ...
                        echo CHtml::encode($expense->getCodeNumber($expenseHeaderConstant));
                        ?>
...
<!--                    <div class="divtablecell info hcolumn2header" style="font-weight: bold">Catatan</div>
                    <div class="divtablecell info hcolumn2value"><?php //echo CHtml::encode(CHtml::value($expense, 'note'));    ?></div>-->
                </div>
            </div>
        </div>
    </div>
...
<table class="memo">
    ...
    <?php foreach ($expenseDetails as $i => $detail): ?>
        <tr class="titems">
    ...
    <tr>
        ...
        <td style="border-top: 2px solid; font-weight: bold; text-align: right; border-right: 1px solid;"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', floor(CHtml::value($expense, 'total')))); ?></td>
...
<div style="text-transform: capitalize">
    Terbilang:
    <?php echo CHtml::encode(NumberWord::numberName(floor(CHtml::value($expense, 'total')))); ?>
    rupiah
</div>
...
<div class="memosig">
    <div style="font-weight:bold; border-left:2px solid; border-right:2px solid; border-bottom:2px solid; border-top:2px solid" class="divtable">
        <div style="border-right:2px solid" class="divtablecell sig1">
            <div>Dibuat,</div>
            <div style="border-top:2px solid"><br/><br/><br/><br/><?php echo CHtml::encode(CHtml::value($expense, 'admin.name')); ?></div>
        </div>
