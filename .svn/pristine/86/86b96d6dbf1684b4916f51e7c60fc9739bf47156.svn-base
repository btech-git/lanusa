...
<div class="hide">
    <div class="form" style="text-align: center">
        ...
        ?>
            ...
            <div class="row" style="background-color: #DFDFDF">
                T / NT
    <?php echo CHtml::activeDropDownlist($receiveHeader, 'is_non_tax', array('1' => 'NonTax', '0' => 'Tax'), array('empty' => '-- All --')); ?>
            </div>
            <?php endif; ?>
...
<?php echo CHtml::endForm(); ?>
    ...
    <div class="clear"></div>
    <div class="right">
<?php echo ReportHelper::sortText($receiveSummary->dataProvider->sort, array('Tanggal', 'Supplier')); ?>
    </div>
    <div class="clear"></div>
</div>

<div>
        <?php $this->renderPartial('_summary', array('receiveSummary' => $receiveSummary, 'branch' => $branch, 'startDate' => $startDate, 'endDate' => $endDate)); ?>
</div>
