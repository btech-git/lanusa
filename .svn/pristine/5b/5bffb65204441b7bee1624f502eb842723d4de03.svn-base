...
Yii::app()->clientScript->registerScript('report', '
	...
	$("#EndDate").val("' . $endDate . '");
	$("#PageSize").val("' . $receivableDetailSummary->dataProvider->pagination->pageSize . '");
	$("#CurrentPage").val("' . ($receivableDetailSummary->dataProvider->pagination->getCurrentPage(false) + 1) . '");
