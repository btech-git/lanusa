...
//    public function actionOutstandingChequeList() {
//        $purchasePaymentData = PurchasePaymentHeader::model()->findAll(array('condition' => 'is_using_cheque = 1 AND status = "Pending"'));
//
//        $this->render('outstandingChequeList', array(
...
//        $valid = $purchasePayment->update(array('status'));
//        
...
//
//        if ($valid) {
//            $this->redirect(array('view', 'id' => $purchasePayment->id));
//        }
//    }
