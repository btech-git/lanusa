...
class PurchaseReceiptSummary extends CComponent
{
	public $dataProvider;
	...
	public function setupLoading()
	{
		$this->dataProvider->criteria->with = array(
			'purchaseReceiptDetails'=>array(
//				'with'=>array('purchaseInvoiceHeader:resetScope'),
			),
			'branch:resetScope',
			'supplier:resetScope',
		);
	...
	public function setupFilter(array $filters)
	{
		...
		$this->dataProvider->criteria->compare('t.supplier_id', $filters['supplierId']);
