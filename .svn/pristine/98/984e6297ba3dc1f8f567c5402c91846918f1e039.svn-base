...
<?php $this->widget('zii.widgets.CDetailView', array(
    ...
    'attributes' => array(
        ...
        array(
            'label' => 'Pembuat',
            'value' => $purchasePayment->admin->username,
        ),
    ),
)); ?>
