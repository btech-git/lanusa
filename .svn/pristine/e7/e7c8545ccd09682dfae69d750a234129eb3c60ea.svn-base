...
<?php $form = $this->beginWidget('CActiveForm', array(
	'id'=>'category-specification-form',
	...
	<div class="row">
		...
		<?php echo $form->dropDownlist($model, 'specification_id', CHtml::listData(Specification::model()->findAll(array('order' => 't.name')), 'id', 'name')); ?>
		<?php echo $form->error($model, 'specification_id'); ?>
	</div>
