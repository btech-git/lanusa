        ...
        <td colspan="4">
            <table>
                <tr>
                    ...
                    <th class="width2-5">Total Hutang</th>
                </tr>
            </table>
        </td>
    </tr>
                ...
                <table>
                    <?php foreach ($header->purchaseReceiptDetails as $detail): ?>
                        <tr>
                            ...
                            <td class="width2-2" style="text-align: center"><?php echo CHtml::encode($detail->receiveHeader->getCodeNumber(ReceiveHeader::CN_CONSTANT)); ?></td>
                            <td class="width2-3" style="text-align: center"><?php echo CHtml::encode(Yii::app()->dateFormatter->format('d MMMM yyyy', strtotime($detail->receiveHeader->date))); ?></td>
                            <td class="width2-4" style="text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($detail, 'receiveHeader.grandTotalReceipt'))); ?></td>
                            <td class="width2-5" style="text-align: center"><?php echo CHtml::encode(CHtml::value($detail, 'memo')); ?></td>
                        </tr>
                    <?php endforeach; ?>
                        
                    <tr>
                        <td colspan="3" style="border-top: 0px solid;text-align: right; font-weight:bold">Total</td>
                        <td class="width2-4" style="border-top: 1px solid;text-align: right; font-weight:bold"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', $header->totalReceive)); ?></td>
                        <?php if ($header->purchasePaymentHeaders == null): ?>
                            <td class="width2-5" style="text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', $header->totalReceive)); ?></td>
                        <?php else: ?>
                ...
                <td colspan="4">
                    <table>
                        ...
                        <?php foreach ($header->purchasePaymentHeaders as $detail): ?>
                            <tr>
                                <td class="width2-1" style="text-align: left"><?php echo CHtml::encode($detail->getCodeNumber(PurchasePaymentHeader::CN_CONSTANT)); ?></td>
                                ...
                                <td  colspan="2" style="text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($detail, 'amountPaid'))); ?></td>
                                <td class="width2-5"></td>
                            </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="border-top: 1px solid;text-align: right; font-weight: bold"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', $totalPayment)); ?></td>
                            <td class="width2-5" style="text-align: center;"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', $totalCredit)); ?></td>
                        </tr>
                    </table>
                </td>
            </tr>
