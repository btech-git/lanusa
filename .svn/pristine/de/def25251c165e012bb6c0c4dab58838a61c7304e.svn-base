...
class PurchaseReceiptHeaderBase extends MonthlyTransactionActiveRecord {
    ...
    public function tableName() {
        return 'tblla_purchase_receipt_header';
    }
    ...
    public function rules() {
        return array(
            ...
            array('id, cn_ordinal, cn_month, cn_year, date, note, grand_total, payment_total, supplier_id, branch_id, admin_id, is_non_tax, is_inactive', 'safe', 'on' => 'search'),
        );
    }
